...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { path: "/analytics/dashboard", label: <T en="Analytics" />, icon: BarChart3 },
        ...
        {filteredNavItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {!isCollapsed && item.badge && <span className="ml-auto bg-red-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full">{item.badge}</span>}
            </Link>
          );
        })}
