...
const {
  ...
  oauthCallback, forgotPassword, resetPassword, updatePhone, updateAvatar, deleteAvatar, updateAddress,
...
router.put('/update-avatar', protect, avatarUpload.single('avatar'), updateAvatar);
